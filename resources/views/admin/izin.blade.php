        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin_absen') }}">Absen</a></li>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="absenForm" action="{{ route('admin.send_izin') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ route('admin_absen') }}" class="btn btn-danger">Kembali</a>
                                    </div>
                                </form>
                            </div>
                        </div>
